package com.uis.assignment.cs385.week2;
...
public class DirectoryLister
{
        ...
        try {
            if (basePath != null) {
                ...
                if (file.exists() || file.listFiles() != null) {
                    ...
                    //-- Calling the method for enumerating the content of directory and passing the file object
                    enumerateDirectory(file);
                } else {

                    //-- Displaying the error in case the filename is invalid
    ...
    private void enumerateDirectory(File f) {
        try {
            ...
            //-- Getting the list of files in the given directory
            ...
            if (list != null) {
                ...
                for (File file : list) {
                    ...
                    //-- Checking if the item in the given directory is a file
                    if (file.isFile()) {
